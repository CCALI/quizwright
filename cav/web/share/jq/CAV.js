...
function initialize()
{
	...
	{	// If bookFile not specified directly, assume a default path.
		...
		// 03/31/2017 QuizWright: Extract Quiz number from query string and load its XML dynamically
		var urlParams = new URLSearchParams(window.parent.location.search);
		var quizID = urlParams.get('quiz');
		trace("Loading quiz #"+quizID);
		bookFile=lessonPath + '../../../book-data-xml.php?lid='+quizID; 
	}
